/*
 * File:   Test_I2CSlave.c
 * Author: 25691
 * a simple project to test the I2C functionality (show the waveform in scope)
 * Created on March 5, 2020, 9:16 AM
 */
...
//    init_ADC();
    ...
    while(1)
    {
        ...
        LATCbits.LATC6 = Rxbuf.data[2]&BIT0;
        LATCbits.LATC7 = (Rxbuf.data[2]>>1)&BIT0;
        __delay_us(10); 
...
void writePortB(unsigned char data)
{
    LATBbits.LATB7 = (data>>7)&BIT0;
    LATBbits.LATB6 = (data>>6)&BIT0;
    LATBbits.LATB5 = (data>>5)&BIT0;
    LATBbits.LATB4 = (data>>4)&BIT0;
    LATBbits.LATB3 = (data>>3)&BIT0;
    LATBbits.LATB2 = (data>>2)&BIT0;
    LATCbits.LATC1 = (data>>1)&BIT0;
    LATCbits.LATC2 = BIT0;
}
